...
namespace VacaBook.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IBookingService bookingService, IVillaService villaService, IVillaNumberService villaNumber,
            IWebHostEnvironment webHostEnvironment, UserManager<ApplicationUser> userManager)
        {
            _bookingService = bookingService;
            _villaService = villaService;
            _villaNumberService = villaNumber;
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
            ...
            _bookingService.UpdatePaymentId(booking.Id, session.Id, session.PaymentIntentId);
        ...
        public IActionResult BookingConfirmation(int bookingId)
        {
            ...
            if (bookingFromDb.Status == SD.StatusPending)
            {
                ...
                if (session.PaymentStatus == "paid")
                {
                    ...
                    _bookingService.UpdatePaymentId(bookingFromDb.Id, session.Id, session.PaymentIntentId);
                }
            }
        ...
        public IActionResult BookingDetails(int bookingId)
        {
            ...
            if (bookingFromDb.VillaNumber == 0 && bookingFromDb.Status == SD.StatusApproved)
            {
                ...
                bookingFromDb.VillaNumbers = _villaNumberService.GetAllVillaNumbers().Where(x => x.VillaId == bookingFromDb.VillaId
